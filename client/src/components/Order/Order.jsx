...
function Order() {
  ...
  const handleSubmit = async (e, currentOrder, TypePay) => {
    e.preventDefault();
    if (currentUser.id) {
      try {
        ...
        if (TypePay === "MP") {
          window.location.href = mercadoPago.paymentUrl
            ? mercadoPago.paymentUrl
            : JSON.parse(localStorage.getItem("mercadoPago")).paymentUrl;
        } else {
          alert("success !!");
          ...
          <div className="Information-buttons">
            ...
            <div className="Information-next">
              ...
              <button
                ...
                type="button"
                onClick={(e) => handleSubmit(e, currentOrder, "paypal")}
              >
                Pagar con mercado paypal.
              </button>

              <button
                className="Information-Back"
                type="button"
                onClick={(e) => handleSubmit(e, currentOrder, "MP")}
              >
